#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""打包并发布 HTML Anything Agent 到 market.aitboy.cn

用法:
    python _publish_html_anything.py
...
AGENT_DIR = HERE / "publish" / "html-anything-agent"
AGENT_JSON = AGENT_DIR / "agent.json"
MARKET_URL = "https://market.aitboy.cn"


def build_tarball() -> Path:
    """将 agent.json 打包成 tar.gz"""
...
def main():
    print("=" * 60)
    print("📦 打包 & 发布 HTML Anything Agent 到市场")
    print("=" * 60)
    ...
    print(f"    Skills: {len(agent.get('skills', []))} 个")
